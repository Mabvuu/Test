    ...
    <div className="min-h-screen flex flex-col items-center justify-center bg-[#f5f5f5] text-gray-700">
      ...
      {view === 'admin' ? (
        <div className="w-full max-w-sm bg-[#808000] rounded-lg shadow-md p-6">
          ...
          <button
            onClick={submitAdmin}
            className="w-full bg-white text-[#6B8E23] py-2 rounded-md hover:bg-[#556B2F] transition-colors"
          >
            LOGIN
          </button>
        </div>
        ...
        <div className="w-full max-w-sm bg-white rounded-lg shadow-md p-6">
          <div className="flex justify-center mb-6">
            <img src="/Test/images/logo1.png" alt="Logo" className="h-36 w-auto" />
          </div>
